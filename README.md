...
- **Active Projections Matrix**: half-life (auto-optimised or frozen),
  ...
  referee strictness, pre-season flag, and travel fatigue as a dropdown
  (0-3). A dynamic, auto-generated paragraph explains WHY each
...
- **Several environmental multipliers are reasoned estimates, not
  ...
  against your own league, adjust them.
